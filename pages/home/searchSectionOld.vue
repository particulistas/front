<template>
    <section >
        <!-- class="lg:bg-[#F3F3F3]" -->
        <div class="bg-gradient-to-r from-[#CB34D9] to-[#E786F0] pl-4 lg:pl-[72px] pr-4 lg:pr-10 py-4 lg:rounded-t-[24px] rounded-b-xl lg:rounded-b-[24px] lg:w-[1083px] mx-[-16px] lg:mx-auto mt-5 lg:mt-0">
