<template>
  <div class="lg:min-w-[340px]">
    <p class="text-[20px] font-medium color-666 mb-2">Fotos de tu anuncio*</p>
    <div v-if="files.length === 0" class="border-2 border-[#27ABB1] rounded-[8px] h-[187px] w-[335px] bg-[#27abb11a] border-dashed flex cursor-pointer" @click="triggerFileInput">
      <div class="m-auto">
        ...
        <p class="text-base color-666 font-light mt-1 text-center">Puedes subir de 3 a 15 fotos</p>
        <p class="text-base text-[#27ABB1] font-bold mt-1 text-center">Subir fotos</p>
      </div>
    </div>
