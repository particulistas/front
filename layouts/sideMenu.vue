    ...
    <transition name="slide">
        <div v-if="isMenuOpen" class="fixed top-0 left-0 z-[2000] bg-[#155D61] rounded-r-[24px] w-[311px] py-4 max-h-[100vh] md:max-h-auto">
            ...
            <div class="mt-9 flex items-center px-6">
                ...
                <p class="text-white text-[20px] font-medium ml-4">Alejandro Rodrigez</p>
            </div>
            ...
            <div class="mt-10">
                ...
                <button class="btn-config ml-4 mb-6 mt-12 flex items-center text-white text-[20px] font-medium">
